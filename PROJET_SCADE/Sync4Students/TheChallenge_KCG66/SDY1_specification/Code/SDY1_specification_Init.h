/*********************************************************
 **
 ** File  SDY1_specification_Init.h
 **
...
#ifndef SDY1_SPECIFICATION_INIT_H
#define SDY1_SPECIFICATION_INIT_H

#include "sgl_types.h"


/* Accessors */
#define SDY1_specification_Init_G_IsInit(_C_) (_C_)->IsInit
#define SDY1_specification_Init_S_IsInit(_C_,_V_) (_C_)->IsInit = (_V_)
#define SDY1_specification_Init_G_tmp(_C_) (_C_)->tmp
#define SDY1_specification_Init_S_tmp(_C_,_V_) (_C_)->tmp = (_V_)
#define SDY1_specification_Init_HOOK(_C_,_F_,_D_) 

/* Context type */
typedef struct SDY1_specification_typ_Init_ {
  /* ------------------------- outputs -------------------------- */
  SGLbool IsInit;
  /* ------------------------- locals --------------------------- */
  SGLbool tmp;
...
} SDY1_specification_typ_Init;

/* Associated functions */
extern void SDY1_specification_Init_init(SDY1_specification_typ_Init *pContext);
extern void SDY1_specification_Init_predraw(SDY1_specification_typ_Init *pContext);
extern void SDY1_specification_Init_draw(SDY1_specification_typ_Init *pContext, SGLint32 pPriority);
extern SDY1_specification_typ_Init * SDY1_specification_Init_alloc(void);
extern void SDY1_specification_Init_free(SDY1_specification_typ_Init *pContext);

#endif /* SDY1_SPECIFICATION_INIT_H */
